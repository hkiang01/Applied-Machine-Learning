...
wdat<-read.table('/home/hkiang2/aml/assignment3/pubfig_dev_50000_pairs.txt')
...
svm<-svmlight(bigx[wtd,], bigy[wtd], svm.options = "-t 1", pathsvm='/home/hkiang2/aml/assignment3/')
...
valdat1<-read.table('/home/hkiang2/aml/assignment3/pubfig_kaggle_1.txt')
valdat2<-read.table('/home/hkiang2/aml/assignment3/pubfig_kaggle_2.txt')
valdat3<-read.table('/home/hkiang2/aml/assignment3/pubfig_kaggle_3.txt')
...
# import solutions
solutions1<-read.table('/home/hkiang2/aml/assignment3/pubfig_kaggle_1_solution.txt', sep=",", header=TRUE)
solutions2<-read.table('/home/hkiang2/aml/assignment3/pubfig_kaggle_2_solution.txt', sep=",", header=TRUE)
solutions3<-read.table('/home/hkiang2/aml/assignment3/pubfig_kaggle_3_solution.txt', sep=",", header=TRUE)
