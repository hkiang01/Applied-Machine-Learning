...
W_conv3 = weight_variable([7, 7, 16, 32])
...
train_writer = tf.train.SummaryWriter('/tmp/mnist_logs6' + '/train', sess.graph)
test_writer = tf.train.SummaryWriter('/tmp/mnist_logs6' + '/test')
