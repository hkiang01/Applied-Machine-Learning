...
h_conv_final = h_pool4

W_fc1 = weight_variable([7 * 7 * 64, 1024])
b_fc1 = bias_variable([1024])

h_pool2_flat = tf.reshape(h_conv_final, [-1, 7*7*64])
...
train_writer = tf.train.SummaryWriter('/tmp/mnist_logs8' + '/train', sess.graph)
test_writer = tf.train.SummaryWriter('/tmp/mnist_logs8' + '/test')
