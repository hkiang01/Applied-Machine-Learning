...
h_conv_final = tf.reshape(h_conv3, [-1, 28*28*8])
...
train_writer = tf.train.SummaryWriter('/tmp/mnist_logs3' + '/train', sess.graph)
test_writer = tf.train.SummaryWriter('/tmp/mnist_logs3' + '/test')
